...
class PrivilegedPassBlockPolicy:
  """
  ...
  def __init__(self, model: mujoco.MjModel, data: mujoco.MjData):
    self.model = model
    self.data = data
    self.policy_stage: PrivilegedPassBlockPolicy.Stage = 'left-greet-block'
    self.subpolicies: Dict[PrivilegedPassBlockPolicy.Stage, Callable[[BimanualObs, Dict], BimanualAction]] = {
    ...
    self.subpolicy_state: Dict[PrivilegedPassBlockPolicy.Stage, Any] = {stage: {} for stage in get_args(PrivilegedPassBlockPolicy.Stage)}
  ...
  def _maintain_stage(self, state: Dict, steps: int, then: 'PrivilegedPassBlockPolicy.Stage'):
  ...
  def _inverse_kinematics_pass(
    ...
    *,
    ...
    on_target_reached: 'PrivilegedPassBlockPolicy.Stage | None' = None
  ) -> BimanualAction:
